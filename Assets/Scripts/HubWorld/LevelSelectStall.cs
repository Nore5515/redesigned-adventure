...
public class LevelSelectStall : MonoBehaviour, Interactable
{
    ...
    {
        if (levelSelectUI.gameObject.activeSelf == false)
        {
            levelSelectUI.OpenLevelSelect();
        }
        else
        {
            levelSelectUI.CloseLevelSelect();
        }    
    }
